    ...
    <section className="section-shell grid min-h-[84vh] items-center gap-9 pb-10 pt-8 sm:pb-14 sm:pt-10 lg:grid-cols-[1.02fr_0.98fr] lg:gap-14 lg:pt-8">
      <div className="max-w-3xl">
        ...
        <h1 className="max-w-[42rem] tracking-normal">
          ...
          <span className="mt-2 block text-[clamp(1.75rem,2.8vw,2.25rem)] font-medium leading-[1.16] text-violet-brand/85">
            Get Consistent Leads &amp; Sales
          </span>
        </h1>
        <p className="mt-5 max-w-xl text-base leading-[1.6] text-muted sm:text-[1.0625rem]">
